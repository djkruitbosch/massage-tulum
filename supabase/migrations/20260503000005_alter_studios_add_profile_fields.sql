...
--          address, phone (E.164), email, description, and updated_at timestamp.
...
-- CHECK constraint: description, if provided, capped at 500 characters
-- (matches architecture doc §2b). Defense in depth — DTO validates first.
ALTER TABLE public.studios
  ADD CONSTRAINT studios_description_max_500
